CREATE TABLE IF NOT EXISTS `coherent-bay-479408-k9.silver_dataset.departments` (
    dept_id STRING,
    name STRING,
...
TRUNCATE TABLE `coherent-bay-479408-k9.silver_dataset.departments`;

-- 3. full load 
INSERT INTO `coherent-bay-479408-k9.silver_dataset.departments`
SELECT DISTINCT 
    deptid,
    name,
    CASE 
...
FROM (
    SELECT DISTINCT *  FROM `coherent-bay-479408-k9.bronze_dataset.departments`
);

-------------------------------------------------------------------------------------------------------

-- 1. Create table providers 
CREATE TABLE IF NOT EXISTS `coherent-bay-479408-k9.silver_dataset.providers` (
    ProviderID STRING,
    FirstName STRING,
    LastName STRING,
...
-- 2. Truncate Silver Table Before Inserting 
TRUNCATE TABLE `coherent-bay-479408-k9.silver_dataset.providers`;

-- 3. full load 
INSERT INTO `coherent-bay-479408-k9.silver_dataset.providers`
SELECT DISTINCT 
    ProviderID,
    FirstName,
    LastName,
    ...
    END AS is_quarantined
FROM (
    SELECT DISTINCT * FROM `coherent-bay-479408-k9.bronze_dataset.providers`
 );
...
CREATE TABLE IF NOT EXISTS `coherent-bay-479408-k9.silver_dataset.encounters` (
  EncounterID STRING,
  PatientID STRING,
  EncounterDate DATE,
...
TRUNCATE TABLE `coherent-bay-479408-k9.silver_dataset.encounters`;
INSERT INTO `coherent-bay-479408-k9.silver_dataset.encounters`
SELECT DISTINCT 
  EncounterID,
  PatientID,
  EncounterDate,
  ...
  END AS is_quarantined
FROM (
  SELECT DISTINCT * FROM `coherent-bay-479408-k9.bronze_dataset.encounters`
);

-----------------------------------------------------------

CREATE TABLE IF NOT EXISTS `coherent-bay-479408-k9.silver_dataset.transactions` (
...
TRUNCATE TABLE `coherent-bay-479408-k9.silver_dataset.transactions`;
INSERT INTO `coherent-bay-479408-k9.silver_dataset.transactions`
SELECT DISTINCT 
  TransactionID,
  EncounterID,
  PatientID,
  ...
  END AS is_quarantined
FROM (
  SELECT DISTINCT * FROM `coherent-bay-479408-k9.bronze_dataset.transactions`
);
...
`coherent-bay-479408-k9.silver_dataset.claims` (
    claim_id STRING,
...
SELECT
    ...
    END AS is_quarantined
FROM
    `coherent-bay-479408-k9.bronze_dataset.claims` t1;
